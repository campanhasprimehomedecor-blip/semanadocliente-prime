      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full bg-[#0c0b0a] border border-[#2d2820] focus:border-[#d4af37] text-xs text-[#f5f1ea] pl-9 pr-3 py-2 rounded-lg outline-none transition-colors placeholder-[#6b6254]"
          />
        </div>
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto w-full md:w-auto pb-1 md:pb-0 scrollbar-none">
          {categories.map((cat) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-montserrat whitespace-nowrap transition-all cursor-pointer ${
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end border-t md:border-t-0 pt-2 md:pt-0 border-[#2d2820]">
          {viewMode === 'flip' && (
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1.5 rounded-lg bg-[#1c1915] border border-[#2e2820] disabled:opacity-30 hover:bg-[#2d2820] text-[#d4af37] cursor-pointer"
